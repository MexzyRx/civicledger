...
export const representatives: Representative[] = [
  ...
  {slug:"ph-state-assembly",role:"State Assembly Member",name:"Hon. Solomon Wami",level:"State",jurisdiction:"Port Harcourt State Constituency I",term:"2023–2027",party:"PDP",initials:"SW",image:"/officials/solomon-wami.jpeg",responsibility:"Represents Port Harcourt Constituency I through legislation, oversight and local advocacy.",commitmentType:"Legislation, oversight and constituency commitments"},
  {slug:"ph-chairman",role:"LGA Chairman",name:"Allwell Ihunda",level:"Local",jurisdiction:"Port Harcourt City LGA",term:"Current council",party:"PDP",initials:"AI",image:"/officials/allwell-ihunda.png",pairedWith:"ph-vice-chairman",responsibility:"Leads the local government executive and oversees municipal programmes and services.",commitmentType:"Local services and delivery promises"},
  {slug:"ph-vice-chairman",role:"Vice Chairman",name:"Tom Quinn Mina Mildred",level:"Local",jurisdiction:"Port Harcourt City LGA",term:"Current council",party:"PDP",initials:"TM",image:"/officials/tom-quinn-mina-mildred.webp",pairedWith:"ph-chairman",responsibility:"Supports the LGA Chairman and leads responsibilities assigned by the local administration.",commitmentType:"Joint-ticket and assigned initiatives"},
  {slug:"ward-6-councillor",role:"Councillor",name:"Hon. Johnbull Damiete",level:"Local",jurisdiction:"Ward 6, Port Harcourt City",term:"Current council",party:"PDP",initials:"JD",image:"/officials/johnbull-damiete.jpg",responsibility:"Represents Ward 6 in the local legislative council and advocates for ward priorities.",commitmentType:"By-laws, oversight and ward commitments"}
];
