...
export const representatives: Representative[] = [
  ...
  {slug:"ph-vice-chairman",role:"Vice Chairman",name:"Tom Quinn Mina Mildred",level:"Local",jurisdiction:"Port Harcourt City LGA",term:"Current council",party:"PDP",initials:"TM",image:"/officials/tom-quinn-mina-mildred.png",pairedWith:"ph-chairman",responsibility:"Supports the LGA Chairman and leads responsibilities assigned by the local administration.",commitmentType:"Joint-ticket and assigned initiatives"},
